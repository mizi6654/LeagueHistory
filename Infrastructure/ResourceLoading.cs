...
namespace League.Infrastructure
{
    ...
    public class ResourceLoading
    {
        ...
        private Dictionary<string, string> CreateAugmentDescriptionMap()
        {
            ...
            //// === 白银符文描述映射 ===
            //AddDescription("火狐", "自动施放：每几秒，获得移动速度并召唤烈焰环绕于你，瞄准距离内相距最近的那个可见英雄并造成自适应伤害。后续命中也会造成伤害。");
            //AddDescription("转得我眩晕了", "将一个召唤师技能替换为骄行荡寇。骄行荡寇发射一根钩爪，吸附在地形上，在此之后，你可以再次施放来绕着它摆荡。在摆荡状态下，自动攻击相距离最近的那个敌人。在与一个敌方英雄碰撞或再次施放时结束摆荡。");
            //AddDescription("速度恶魔", "用一个技能对一个敌方英雄造成伤害时，暂时获得移动速度。");
            //AddDescription("升级：荆棘之甲", "你获得一个护盾，这个护盾在被打破时，会对攻击者和施法者造成魔法伤害。这个护盾会在未受到伤害秒后生成。荆棘护盾的回敬伤害受益于最大生命值，魔法抗性和护甲。");
            //AddDescription("双生火焰", "造成技能伤害时，发射个爆竹，每个造成魔法伤害。此外，获得暴击几率。");
            //AddDescription("海克斯科技龙魂", "周期性地使你的下一个伤害型技能或攻击触发一道闪电爆裂，连锁穿过敌人以造成伤害和减速。");
            //AddDescription("砸开那颗蛋", "你的护盾值将在到期时爆炸。");
            //AddDescription("负重爆气", "用技能击中敌人时，会为你提供【爆气】层数，使你的技能冷却时间转得更快。");
            //AddDescription("杀意翻涌", "在朝着低生命值的敌人时，获得额外移动速度。");
            //AddDescription("属性！", "获得2个【属性锻造器】！");
            //AddDescription("狂热者", "获得暴击几率和攻击速度。");
            //AddDescription("注魔", "攻击特效消耗法力值以造成魔法伤害，这个伤害可以暴击。");
            //AddDescription("纯粹主义者 - 术师", "获得百分比冷却缩减并将你的所有攻击速度转化为技能急速。");
            //AddDescription("由暴生急", "获得相当于你暴击几率的技能急速。");
            ...
            //// === 黄金符文描述映射 ===
            //AddDescription("暴击飞弹", "当你暴击时，发射1+个爆竹，每个造成魔法伤害。此外获得%暴击几率。");
            //AddDescription("弹球", "你的雪球获得技能急速并且造成额外的真实伤害。它可以从墙体上反弹，从而提升它的体型和伤害，并缩短它的冷却时间。");
            //AddDescription("缩小引擎", "参与击杀后会让你变小并且获得技能急速和移动速度。阵亡时损失%层数。");
            //AddDescription("吞噬灵魂", "定向一个敌方英雄时会提供最大生命值。");
            //AddDescription("损赠", "获得金币。无需多问。");
            //AddDescription("超凡邪恶", "在你用技能命中敌人时永久获得法术强度。如果是作为你的第二个强化符文，则自带法术强度。");
            //AddDescription("红包", "红包会随机出现在你周围。拾取它们会给你金币和少量的某个随机属性。");
            //AddDescription("最终都市列车", "在你阵亡时，朝击杀你的敌人发动一辆列车，对它命中的每个敌人造成物理伤害。这个列车不会停下。");
            //AddDescription("生机迸发", "获得【生机迸发】召唤师技能。【生机迸发】会猛然提升你的体型，击飞附近的敌人们并提供最大生命值。");
            //AddDescription("祖母的辣椒油", "施加一个灼烧时，会在附近掉落一个辣椒油池子。站在一个辣椒油池子上会回复生命值并灼烧敌人们。你可施加的每个灼烧都会使辣椒油池子变得更强。");
            //AddDescription("魄罗爆破手", "你周期性地召唤集魄罗。伤害敌人时会对其发射所有魄罗，每个造成最大生命值真实伤害以及短暂的击退。");
            //AddDescription("咏叹奏鸣", "以一个不断交替的旋律来自动施放【坚毅咏叹调】和【迅捷奏鸣曲】。");
            //AddDescription("属性叠属性！", "获得3个【属性锻造器】。");
            //AddDescription("双发快射", "你的暴击施加一次额外的攻击特效。获得暴击几率。");
            ...
            //// === 棱彩符文描述映射 ===
            //AddDescription("任务：艾卡西亚的陷落", "即刻：获得一个【斑比的熔渣】并且你可以购买2件献祭装备。需求：持有【日炎圣盾】和【璀璨回响】。奖励：持有【日炎圣盾】和【璀璨回响】组合成【虚空献祭】。");
            //AddDescription("无限循环往复", "获得技能急速，外加每次参与击杀技能急速。");
            //AddDescription("男爵之手", "获得%适应之力。附近友方小兵都获得极大增强。");
            //AddDescription("神圣雪球", "雪球获得技能急速。你在用【雪球】冲刺后短暂免疫伤害。如果你没有雪球，获得一个雪球。");
            //AddDescription("和我一起困在这里", "使用你的终极技能时会嘲讽附近的敌人们并提供给你持续若干秒的伤害减免。");
            //AddDescription("卡皮巴拉空投", "获得召唤师技能卡皮巴拉空投。在一阵延迟后，召唤一个卡皮巴拉落下，造成%最大生命值的真实伤害。");
            //AddDescription("舞会女王", "周期性地自动施放一道聚光灯降临在你身上。当它着陆时，获得洛的终极技能，魅惑你碰到的敌人们。");
            //AddDescription("???", "你的“敌人消失信号”将发射一个飞弹至被信号标记的位置，这个飞弹会伤害敌人并治疗友军。");
            //AddDescription("当心小蛋糕", "小蛋糕将间歇性地飞越整个大桥。小蛋糕会提供金币给接住它的人，并对第一个命中的英雄及其附近的友军回复生命值。你获得基于小蛋糕治疗效果的金币。");
            //AddDescription("虚空裂隙", "用技能对敌人造成伤害时，会制造一道虚空裂隙。如果附近有另一道虚空裂隙，则它们会连接来对它们之间的敌人们造成魔法伤害和减速。");
            //AddDescription("魄罗之王的弹跳", "将一个召唤师技能替换为魄罗之王的弹跳！魄罗之王的弹跳：变形为【魄罗之王】，拥有无法被阻挡、幽灵状态、获得伤害减免和移动速度，但不能攻击或使用技能。此外，反复弹跳，造成物理伤害并击退附近的敌方英雄。");
            //AddDescription("信念者的强化", "为友军提供治疗或护盾会积攒【虔诚】。在攒满【虔诚】时，释放一道冲击波来处决低生命值的敌人们。");
            //AddDescription("扳机炼狱", "获得悍勇本色。在你达到S评价等级时，自动使用炼狱扳机。悍勇本色 - 使用与前一个不同的技能或攻击对敌人造成伤害时，会获得评价等级（从F到S）。从每评价等级中获得移动速度。炼狱扳机 - 倾泻出大量的子弹，对附近的敌人们造成物理伤害。");
            //AddDescription("飞身踢", "你的攻击会处决低生命值的敌方英雄，从而将其击退并引发爆炸，这个爆炸会治疗你。");
            //AddDescription("你肩上的恶魔", "与【大魔王】本尊签订一个契约。他持续汲取你的生命力，但回报给你力量，让你对英雄造成额外真实伤害并且创造治疗残片供你获取。");
            //AddDescription("属性叠属性叠属性！", "获得4个【属性锻造器】！");
            ...
            // === 白银符文描述映射 ===
            AddDescription("火狐", "每 7 秒获得 25% 移动速度（2 秒衰减）并召唤 3 道烈焰，自动瞄准最近可见英雄造成 35-160（基于等级）（+25% 额外 AD）（+25% AP）自适应伤害（后续命中同一目标仅 30% 伤害）。");
            AddDescription("转得我眩晕了", "将一个召唤师技能替换为骄行荡寇（钩爪吸附地形后可摆荡，期间自动攻击最近敌人，与英雄碰撞或再次施放结束）。");
            AddDescription("速度恶魔", "用技能对敌方英雄造成伤害时，获得短暂高额移动速度（0.75 秒内衰减）。");
            AddDescription("升级：荆棘之甲", "周期性获得护盾，被打破时对攻击者和施法者造成基于最大生命值、护甲、魔抗的魔法伤害。");
            AddDescription("双生火焰", "造成技能伤害时发射爆竹，每个造成魔法伤害。此外获得暴击几率。");
            AddDescription("海克斯科技龙魂", "周期性使你的下一个伤害型技能或攻击触发闪电爆裂，连锁穿过敌人造成伤害和减速。");
            AddDescription("砸开那颗蛋", "你的护盾到期时爆炸，对附近敌人造成等于 100% 护盾强度的魔法伤害。");
            AddDescription("负重爆气", "用技能击中敌人时获得爆气层数，提升技能冷却缩减速度。");
            AddDescription("杀意翻涌", "朝低于 40% 生命值的敌人移动时获得 60% 额外移动速度。");
            AddDescription("属性！", "获得 2 个【属性锻造器】！");
            AddDescription("狂热者", "获得 25% 暴击几率和 35% 攻击速度。");
            AddDescription("注魔", "攻击特效消耗 2.5% 最大法力值，造成等于消耗法力 4.5% 的可暴击魔法伤害。");
            AddDescription("纯粹主义者 - 术师", "获得百分比冷却缩减，并将所有攻击速度转化为技能急速。");
            AddDescription("由暴生急", "获得等于你 40% 暴击几率的技能急速。");

            AddDescription("物理转魔法", "将所有额外攻击力以 1 AD : 0.6 AP 转化为法术强度，并额外获得 15% 法术强度。");
            AddDescription("大力", "攻击力提升 20%。");
            AddDescription("霸符兄弟", "你获得【余烬之冠】和【洞悉之冠】。");
            AddDescription("灵巧", "获得 60% 攻击速度。");
            AddDescription("俯冲轰炸", "在你阵亡时爆炸，对附近的敌人们造成目标 20% 最大生命值的真实伤害。");
            AddDescription("唯快不破", "你对比你移动速度慢的目标，每多 10 移速多造成 1% 伤害。");
            AddDescription("侵蚀", "对敌人造成伤害时会施加护甲和魔法抗性击碎效果（最多 30% 减抗）。");
            AddDescription("急救用具", "获得 20% 治疗和护盾强度。");
            AddDescription("闪光弹", "闪现时引发爆炸，造成 70-240（+70% AD）（+60% AP）魔法伤害并减速 35%（1.25 秒）。阵亡时重置闪现。");
            AddDescription("冰霜 幽灵", "每 6.5 秒，自动施放禁锢给附近的敌人们（450 码范围，1.25 秒禁锢）。");
            AddDescription("渴血", "获得 15% 全能吸血。");
            AddDescription("恶趣味", "定身或缚地敌方英雄时回复 30-250（+1.5% 最大生命值）生命值（5 秒冷却）。");
            AddDescription("重量级打击手", "你的攻击造成相当于你 3.5% 最大生命值的额外物理伤害。");
            AddDescription("冰寒", "你的减速效果额外降低目标 75 移动速度。");
            AddDescription("炼狱龙魂", "你获得炼狱龙魂。");
            AddDescription("练腿日", "获得 50 移动速度和 40% 减速抗性。");
            AddDescription("由心及物", "使你的最大生命值提升，数额相当于你 50% 的最大法力值（上限 99999）。");
            AddDescription("海洋龙魂", "获得【海洋龙魂】（基础治疗值改为 100）。");
            AddDescription("退敌力场", "在你较低或低生命值时（<35%），附近的敌人们会被击退并减速 90%（1.5 秒），冷却 25 秒。");
            AddDescription("万用瞄准镜", "获得 75（近战）/50（远程）攻击距离。");
            AddDescription("自我毁灭", "每个回合开始时会有炸弹附在你身上。5 秒后爆炸，造成 20% 最大生命值真实伤害并击飞附近的敌人们。");
            AddDescription("暗影疾奔", "在使用一个冲刺、跳跃、闪烁或传送类技能或离开潜行状态之后，获得 300 移动速度（持续 2 秒）。");
            AddDescription("扇巴掌", "每当你定身或缚地敌人时，获得可叠加的适应之力。阵亡时损失层数。");
            AddDescription("天音爆", "在为你的友军提供增益效果、治疗效果或护盾效果时，会对其附近的敌人们造成 30-150 真实伤害和减速 30%（2 秒）。");
            AddDescription("旋转至胜", "你的旋转类技能获得技能急速并且多造成 30% 伤害！");
            AddDescription("会心防御", "你可以使用你的暴击几率来进行会心防御，使你有一定几率来使所受伤害降低。获得暴击几率。");
            AddDescription("残暴之力", "获得攻击力、技能急速和穿甲。");
            AddDescription("折磨者", "定身或缚地敌方英雄时还会施加灼烧，造成魔法伤害。灼烧可无限叠加。");
            AddDescription("质变：黄金阶", "获得1个随机黄金阶强化符文。");
            ...
            AddDescription("魔法转物理", "将法术强度转化为额外攻击力，并获得攻击力。");
            AddDescription("坚若磐石", "每当你定身或缚地敌人时，获得护甲或者魔抗。");
            AddDescription("逃跑计划", "在低生命值（<35%）时，获得 65% 最大生命值护盾、150% 额外移动速度和缩小效果（持续 5.5 秒衰减）。");
            AddDescription("血上加伤", "朝被雪球标记的敌人移动时获得额外移动速度。你可以拾取友军的雪球来刷新你自己的。");
            AddDescription("闪闪现现", "获得第二个【闪现】召唤师技能和召唤师技能急速。");
            AddDescription("帽上加帽", "头戴式装备和帽子(包含帽子饮品)提供法术强度和魔法抗性。");
            AddDescription("强力护盾", "当你获得护盾时，获得 40-100（基于等级）适应之力（3 秒，5 秒冷却）。");
            AddDescription("吵闹鬼", "获得【吵闹鬼】召唤师技能。");
            AddDescription("活力再生", "你的【盈能攻击】充能数会得到全额返还，如果目标与你前一次攻击的目标不是同一个。【盈能攻击】造成额外魔法伤害。");
            AddDescription("快中求稳", "在冲刺或闪烁后，获得护盾值。");
            AddDescription("防护面纱", "获得一层法术护盾来格挡下一个敌方技能。");
            AddDescription("刃下生风", "从护甲穿透和法术穿透中获得移动速度。");
            AddDescription("点亮他们！", "每第4次攻击发射 4 道火炮，共造成 44-320（+140% 额外 AD）（+76% AP）额外魔法伤害。");
            AddDescription("山脉龙魂", "你获得山脉龙魂。");
            AddDescription("家园卫士", "获得 100% 移动速度，在受到英雄伤害后 6 秒失效。");
            AddDescription("叠角龙", "在你获得一个技能的永久层数时，多获得75%。");

            // === 黄金符文描述映射 ===
            AddDescription("损赠", "即刻获得 1750 金币（大量金币，无需多问）。");
            AddDescription("暴击飞弹", "当你暴击时，发射 1（+每 33.33% 暴击几率额外 1 个）爆竹，每个造成 20-100（基于等级）魔法伤害。此外获得 25% 暴击几率。");
            AddDescription("弹球", "你的雪球获得大量技能急速并且造成额外的真实伤害。它可以从墙体上反弹，从而提升它的体型和伤害，并缩短它的冷却时间。");
            AddDescription("缩小引擎", "参与击杀后会让你变小并且获得技能急速和移动速度。阵亡时损失层数。");
            AddDescription("吞噬灵魂", "定向一个敌方英雄时会提供最大生命值。");
            AddDescription("超凡邪恶", "在你用技能命中敌人时永久获得法术强度。如果是作为你的第二个强化符文，则自带额外法术强度。");
            AddDescription("红包", "红包会随机出现在你周围。拾取它们会给你金币、移动速度和少量的某个随机永久属性。");
            AddDescription("最终都市列车", "在你阵亡时，朝击杀你的敌人发动一辆列车，对命中的每个敌人造成 150-750（+65% 额外 AD）（+50% AP）（+15% 最大生命值）物理伤害。这个列车不会停下。");
            AddDescription("生机迸发", "获得【生机迸发】召唤师技能。猛然提升你的体型，击飞附近的敌人们并提供最大生命值。");
            AddDescription("祖母的辣椒油", "施加一个灼烧时，会在附近掉落一个辣椒油池子。站在池子上会回复生命值并灼烧敌人们。每个灼烧都会使池子变得更强。");
            AddDescription("魄罗爆破手", "你周期性地召唤集魄罗。伤害敌人时会对其发射所有魄罗，每个造成基于 3% 最大生命值的真实伤害以及短暂的击退。");
            AddDescription("咏叹奏鸣", "以一个不断交替的旋律来自动施放【坚毅咏叹调】和【迅捷奏鸣曲】。");
            AddDescription("属性叠属性！", "获得 3 个【属性锻造器】。");
            AddDescription("双发快射", "你的暴击施加一次额外的攻击特效。获得暴击几率。");

            AddDescription("全心为你", "你的治疗和护盾在用在友军身上时会变强（提升 30%）。");
            AddDescription("尖端发明家", "获得 100 装备急速（≈50% 物品冷却缩减）。");
            AddDescription("超强大脑", "获得基于 300% AP 的护盾值。阵亡时重置。");
            AddDescription("面包和黄油", "你的Q获得 100 技能急速。");
            AddDescription("面包和奶酪", "你的E获得 100 技能急速。");
            AddDescription("面包和果酱", "你的W获得 100 技能急速。");
            AddDescription("星界躯体", "获得 1500 生命值，但你造成的伤害降低 10%。");
            AddDescription("会心治疗", "你的治疗和护盾可以暴击（提升 40% 效果）。获得 25% 暴击几率。");
            AddDescription("黎明使者的坚决", "在低生命时（<50%），3 秒内持续回复 30% 最大生命值（45 秒冷却）。");
            AddDescription("魔鬼之舞", "获得【迅捷步法】和【不灭之握】基石符文。");
            AddDescription("神圣干预", "战斗开始后，召唤护体星星缓慢的降落在你身上。在它着陆时，你和附近的友军们进入免疫伤害状态。");
            AddDescription("虚幻武器", "你的技能可施加附带伤害攻击特效。");
            AddDescription("裁决使", "对低生命值的敌人们多造成伤害。在参与击杀后重置你的基础技能。");
            ...
            AddDescription("圣火", "你的治疗或护盾会对附近的敌人施加无限叠加的灼烧，造成魔法伤害。");
            AddDescription("不动如山", "获得【余震】和【冰川增幅】基石符文。");
            AddDescription("关键暴击", "获得 50% 暴击几率。");
            AddDescription("杀戮时间到了", "在施放你的终极技能后，将敌人打上死亡标记。这个标记会将对其造成的伤害储存起来，然后引爆，造成已储存的伤害。");
            AddDescription("基石法师", "获得【召唤：艾黎】和【奥术彗星】基石符文。");
            AddDescription("闪电打击", "获得攻击速度。在特定攻击次数/秒时，造成额外的附带魔法伤害攻击特效。");
            AddDescription("魔法飞弹", "用技能造成伤害时，会对被命中的敌人发射魔法飞弹，造成基于飞行距离提升的真实伤害。");
            AddDescription("仆从大师", "你的召唤物获得 40% 体型、生命值和伤害提升。");
            AddDescription("回力OK镖", "每 10 秒朝着附近的敌人自动施放投掷回力镖，对命中的敌人们造成 40-200（+30% 额外 AD）（+20% AP）自适应伤害。");
            AddDescription("狂徒豪气", "你的冲刺、跳跃、闪烁或传送类技能会为你提供护甲和魔法抗性（可叠加）。");
            AddDescription("溢流", "你的潜力值消耗翻倍。你的技能的治疗效果、护盾效果和伤害获得提升，提升幅度基于你的最大法力值。");
            AddDescription("坚韧", "获得基础生命回复，在低生命值时还会获得提升。");
            AddDescription("任务：钢化你心", "需求：持有【心之钢】且层数在一定层数或以上。奖励：将你的心之钢层数乘以一定倍数。");
            AddDescription("古式佳酿", "使用技能时会回复生命值。");
            ...
            // === 棱彩符文描述映射 ===
            AddDescription("任务：艾卡西亚的陷落", "即刻：获得一个【斑比的熔渣】并且你可以购买2件献祭装备。需求：持有【日炎圣盾】和【璀璨回响】。奖励：合成【虚空献祭】。");
            AddDescription("无限循环往复", "获得 60 技能急速，外加每次参与击杀 +3 技能急速（无限叠加）。");
            AddDescription("男爵之手", "获得大量适应之力。附近友方小兵都获得极大增强。");
            AddDescription("神圣雪球", "雪球获得技能急速。你在用【雪球】冲刺后获得 1.5 秒免疫伤害。如果你没有雪球，获得一个雪球。");
            AddDescription("和我一起困在这里", "使用你的终极技能时会嘲讽附近的敌人们并提供给你持续若干秒的伤害减免。");
            AddDescription("卡皮巴拉空投", "获得召唤师技能卡皮巴拉空投。在一阵延迟后，召唤一个卡皮巴拉落下，造成 % 最大生命值的真实伤害。");
            AddDescription("舞会女王", "周期性地自动施放一道聚光灯降临在你身上。当它着陆时，获得洛的终极技能，魅惑你碰到的敌人们。");
            AddDescription("???", "你的“敌人消失信号”将发射一个飞弹至被信号标记的位置，这个飞弹会造成 100-400（+10% 目标缺失生命）魔法伤害并治疗友军 50-200（+10% 缺失生命）（有 ping 限制）。");
            AddDescription("当心小蛋糕", "小蛋糕将间歇性地飞越整个大桥。拾取提供治疗（50-250 + 缺失生命%）并获金币（基于治疗量）。");
            AddDescription("虚空裂隙", "用技能对敌人造成伤害时，会制造一道虚空裂隙。如果附近有另一道虚空裂隙，则它们会连接来对它们之间的敌人们造成魔法伤害和减速。");
            AddDescription("魄罗之王的弹跳", "将一个召唤师技能替换为魄罗之王的弹跳！变形为魄罗之王（减伤、移速、无控、幽灵），反复弹跳造成 100-700 物理伤害并击退附近的敌方英雄。");
            AddDescription("信念者的强化", "为友军提供治疗或护盾会积攒【虔诚】。在攒满【虔诚】时，释放一道冲击波来处决低生命值的敌人们。");
            AddDescription("扳机炼狱", "获得悍勇本色。在你达到S评价等级时，自动使用炼狱扳机倾泻子弹造成物理伤害。");
            AddDescription("飞身踢", "你的攻击会处决低生命值的敌方英雄，从而将其击退并引发爆炸治疗你。");
            AddDescription("你肩上的恶魔", "与【大魔王】签订契约，提供额外真实伤害和治疗残片（持续汲取生命）。");
            AddDescription("属性叠属性叠属性！", "获得 4 个【属性锻造器】！");

            AddDescription("回归基本功", "你的终极技能已被封印。获得技能伤害、治疗效果、护盾、技能急速。");
            AddDescription("利刃华尔兹", "让你进入不可被选取状态，在此期间对敌人进行突进并造成物理伤害（总计 180-900（+60% 额外 AD）（+36% AP））。");
            AddDescription("你摸不到", "施放你的终极技能会使你进入免疫伤害状态（2 秒，8 秒冷却）。");
            AddDescription("死亡之环", "你造成的治疗效果和生命回复效果会对敌方英雄造成 70% 数值的魔法伤害。");
            AddDescription("小丑学院", "获得召唤师技能【欺诈魔术】。获得【背刺】和【幻像】被动。");
            AddDescription("巨像的勇气", "定身或缚地敌方英雄后获得 150-450（+4% 最大生命值）护盾值（可叠加）。");
            AddDescription("残忍", "定身或缚地敌方英雄时，召唤彗星至敌人上方。彗星着陆时造成 50-150（+40% AP）（+4% 最大生命值）魔法伤害。");
            AddDescription("全凭身法", "你的冲刺、跳跃、闪烁或传送类技能获得 175 技能急速。");
            AddDescription("亮出你的剑", "变为近战状态，并获得攻击力、生命值、攻击速度、生命偷取和移动速度。");
            AddDescription("双刀流", "在攻击时，发射弩箭，造成效能削减的附带伤害攻击特效。获得攻击速度。");
            AddDescription("尤里卡", "获得相当于 30% 法术强度的技能急速。");
            AddDescription("连拨击锤", "在你攻击时，发射额外弩箭，弩箭造成基于移动距离提升的物理伤害。弩箭能够暴击前附带攻击特效。");
            AddDescription("感受燃烧", "获得召唤师技能【感觉灼烧】。");
            AddDescription("精怪魔法", "你的终极技能的伤害会对敌人造成持续若干秒的变形效果。");
            AddDescription("巨人杀手", "体型变小，获得移动速度，对体型大于你的敌方英雄造成额外伤害。");
            ...
            AddDescription("最终形态", "在施放你的终极技能时，获得护盾、全能吸血和额外移动速度。");
            AddDescription("砍伤", "攻击造成附带真实伤害攻击特效。");
            AddDescription("玻璃大炮", "减少最大生命值（约30%），造成额外真实伤害。");
            AddDescription("夺金", "用攻击或技能对英雄造成伤害时会造成额外魔法伤害，并为你提供金币和移动速度。");
            AddDescription("尊我为王", "当你第一次携带一件传说级装备并乘坐敌人的传送门时，你会升级你的装备并获得随机棱彩阶强化符文（额外 1000 金币价值）。");
            AddDescription("激光治疗", "施放治疗激光，治疗友军生命值，对敌人造成魔法伤害并使敌人减速。");
            AddDescription("不祥契约", "基于已损失生命值，获得法术强度，移动速度和全能吸血。施放技能会消耗你的当前生命值。");
            AddDescription("蛋白粉奶昔", "获得治疗和护盾强度。基于额外护甲和魔法抗性。");
            AddDescription("王中王,靴中靴", "即刻：随机获得一双升级后的靴子。需求：完成其任务，以更换为另一双。奖励：嘉文一世之靴。");
            ...
            AddDescription("轨道镭射", "获得召唤师技能轨道镭射，在一阵延迟后，召唤一道轨道镭射光束落下，造成真实伤害外加持续造成魔法伤害。");
            AddDescription("潘朵拉的盒子", "将你的所有强化符文变为随机的棱彩阶强化符文。");
            AddDescription("精准奇才", "当你对700码距离以外的敌人造成伤害时，会朝该方向自动施放一道伊泽瑞尔的R，对途径的敌人们造成100-350（+80%额外攻击力）（+60%法术强度）魔法伤害。冷却时间：15秒，并非单目标冷却。");
