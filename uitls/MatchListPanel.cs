...
namespace League
{
    public class MatchListPanel : Panel, IDisposable
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                g.FillRectangle(backgroundBrush, base.ClientRectangle);
            }
            ...
            int borderPadding = 2;
            Rectangle borderRect = new Rectangle(0, base.Height - (int)textSize.Height - borderPadding - 2, (int)textSize.Width + borderPadding * 2, (int)textSize.Height + borderPadding * 2);
            ...
            int statsX = base.Width + 190 - 10 - 450;
            ...
            g.DrawRectangle(borderPen2, 0, 0, base.Width - 1, base.Height - 1);
        }
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            {
                this.ReplayClicked?.Invoke(MatchInfo);
            }
            else if (_detailsRect.Contains(e.Location))
            {
                this.DetailsClicked?.Invoke(MatchInfo);
            }
            else
            {
                if (MatchInfo == null)
                ...
                foreach (Tuple<Rectangle, PlayerInfo> tuple in GetPlayerIconRegions())
                {
                    ...
                    try
                    {
                        ...
                        {
                            this.PlayerIconClicked?.Invoke(tuple.Item2.SummonerId.ToString());
                        }
                        break;
                    }
                    catch
